    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          type="password"
          required
          className={`mt-1 w-full rounded-xl border px-4 py-3 text-sm text-text-primary-light outline-none focus:border-primary/40 focus:ring-2 focus:ring-primary/30 ${
            confirmPassword && !confirmValid
              ? "border-red-400 bg-red-50"
              : "border-border-light/70 bg-background-light"
          }`}
        />
        {confirmPassword && !confirmValid && (
