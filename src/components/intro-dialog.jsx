...
export function IntroDialog() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
      <div className="w-full max-w-lg rounded-3xl border border-border-light/70 bg-surface-light p-8 text-center shadow-2xl">
        ...
        <p className="mt-3 text-sm leading-relaxed text-text-secondary-light">
          전주대학교 컴퓨터공학과 학생들이 강의 자료와 게시판을 한 곳에서
          이용할 수 있는 공간입니다. 로그인 후 자료를 공유하거나 팀원들과
          소식을 나눠보세요.
        </p>
        <div className="mt-6 flex flex-col gap-3 text-sm text-text-secondary-light">
          <p>1) 자료실에서 최신/인기 공유 자료를 확인하세요.</p>
          <p>2) 게시판에 스터디 소식과 공지를 편하게 남겨보세요.</p>
          <p>
            3) 문의가 필요하면{" "}
            <Link
